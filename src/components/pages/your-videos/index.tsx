import { AddVideoButton, ClearButton, CloseButton, Container, Modal, ModalContent, ModalTitle, ThumbnailURL, UserContainer, UserName, VideoDescription, VideoTitle, YourVideosContainer } from "./style";
import { UsersContext } from "../../../contextApi/usersContext";
import { useContext, useState, useRef } from "react";
import { UserContext } from "../../../contexts/userContext";
import YourVideosCards from "../../../components/yourVideosCards/index";
import { InputEmpty, MessageContainer } from "../../pages/sign-up/style";
...
function YourVideos() {
  ...
  const { user, userVideos, createVideos, token } = useContext(UsersContext)
